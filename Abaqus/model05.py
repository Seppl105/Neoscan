...
yCoorEnd = 0.01            # [m] y Coordinate am Ende des ersten Pancakes
...
assembly.Instance(name='Part-Pancake-1', part=partPancake, dependent=ON)
...
if t_confinement != -1:
    ...
    materialIns.Elastic(table=((E_confinement, ny_confinement), ))
    ...
    yOffSetConfinement = 20*t_confinement   # this is used to create a visible offset
    sketchConfinement.rectangle(point1=(r_a, yCoorStart + yOffSetConfinement), point2=(r_a + t_confinement, yCoorEnd + yOffSetConfinement))
    ...
    faceConfinement = partConfinement.faces.findAt(((r_a + t_confinement/2, yCoorMid + yOffSetConfinement, 0.0),))
    ...
    assembly.Instance(name='Part-Confinement-1', part=partConfinement, dependent=ON)
...
assembly = mdb.models['Model-Coil'].rootAssembly # may be redundant
facesPancake = assembly.instances['Part-Pancake-1'].faces
