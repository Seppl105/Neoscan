...
j = 114.2               # [A/m^2] Stromdichte * (1000**2) # [A/m^2] Stromdichte
b_za = -2.5      # [T] magnetische Flussdichte außen    -2.5             # [T] magnetische Flussdichte außen
b_zi = 14        # [T] magnetische Flussdichte innen   14               # [T] magnetische Flussdichte innen
...
plt.plot(r, 10**(-6) *  calcStresses(r=r, s_z0=0, s_ri=0, s_ra=0, nu=0.3, b_za=b_za, b_zi=b_zi, b_0=b_0, j=j)[0], label="s_r nach Caldwell")
plt.legend()
...
plt.plot(r, 10**(-6) *  calcStresses(r=r, s_z0=0, s_ri=0, s_ra=0, nu=0.3, b_za=b_za, b_zi=b_zi, b_0=b_0, j=j)[1], label="s_phi nach Caldwell")
plt.legend()
